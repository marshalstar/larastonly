...
@section('create-url'){{ URL::route("states.create") }} @stop
...
@section('show-url'){{ URL::route("states.show", "key") }} @stop
@section('edit-url'){{ URL::route("states.edit", "key") }} @stop
@section('destroy-url'){{ URL::route('states.destroy', 'key') }} @stop